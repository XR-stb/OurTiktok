...
func (x *GetFavoritesReq) GetUserId() int64 {
	if x != nil {
		return x.UserId
	}
	return 0
...
func (x *GetFavoritesReq) GetVideoIds() []int64 {
	if x != nil {
		return x.VideoIds
	}
	return nil
...
type GetFavoritesRes struct {
	...
	Status    Status          `protobuf:"varint,1,opt,name=Status,proto3,enum=favorite.Status" json:"Status,omitempty"`
	Favorites []*FavoriteInfo `protobuf:"bytes,2,rep,name=Favorites,proto3" json:"Favorites,omitempty"`
}
...
func (x *GetFavoritesRes) GetStatus() Status {
	if x != nil {
		return x.Status
	}
	return Status_OK
...
func (x *GetFavoritesRes) GetFavorites() []*FavoriteInfo {
	if x != nil {
		return x.Favorites
	}
	return nil
...
var file_favorite_proto_rawDesc = []byte{
	...
	0x12, 0x08, 0x66, 0x61, 0x76, 0x6f, 0x72, 0x69, 0x74, 0x65, 0x22, 0x9a, 0x01, 0x0a, 0x08, 0x55,
	...
	0x73, 0x46, 0x6f, 0x6c, 0x6c, 0x6f, 0x77, 0x22, 0xf9, 0x01, 0x0a, 0x05, 0x56, 0x69, 0x64, 0x65,
	0x6f, 0x12, 0x0e, 0x0a, 0x02, 0x49, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x03, 0x52, 0x02, 0x49,
	0x64, 0x12, 0x2a, 0x0a, 0x06, 0x41, 0x75, 0x74, 0x68, 0x6f, 0x72, 0x18, 0x02, 0x20, 0x01, 0x28,
	0x0b, 0x32, 0x12, 0x2e, 0x66, 0x61, 0x76, 0x6f, 0x72, 0x69, 0x74, 0x65, 0x2e, 0x55, 0x73, 0x65,
	0x72, 0x49, 0x6e, 0x66, 0x6f, 0x52, 0x06, 0x41, 0x75, 0x74, 0x68, 0x6f, 0x72, 0x12, 0x18, 0x0a,
	...
	0x74, 0x6c, 0x65, 0x22, 0x54, 0x0a, 0x0c, 0x46, 0x61, 0x76, 0x6f, 0x72, 0x69, 0x74, 0x65, 0x49,
	0x6e, 0x66, 0x6f, 0x12, 0x24, 0x0a, 0x0d, 0x46, 0x61, 0x76, 0x6f, 0x72, 0x69, 0x74, 0x65, 0x43,
	0x6f, 0x75, 0x6e, 0x74, 0x18, 0x01, 0x20, 0x01, 0x28, 0x03, 0x52, 0x0d, 0x46, 0x61, 0x76, 0x6f,
	0x72, 0x69, 0x74, 0x65, 0x43, 0x6f, 0x75, 0x6e, 0x74, 0x12, 0x1e, 0x0a, 0x0a, 0x49, 0x73, 0x46,
	0x61, 0x76, 0x6f, 0x72, 0x69, 0x74, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x08, 0x52, 0x0a, 0x49,
	0x73, 0x46, 0x61, 0x76, 0x6f, 0x72, 0x69, 0x74, 0x65, 0x22, 0x5d, 0x0a, 0x09, 0x41, 0x63, 0x74,
	...
	0x07, 0x56, 0x69, 0x64, 0x65, 0x6f, 0x49, 0x64, 0x12, 0x1e, 0x0a, 0x0a, 0x41, 0x63, 0x74, 0x69,
	0x6f, 0x6e, 0x54, 0x79, 0x70, 0x65, 0x18, 0x03, 0x20, 0x01, 0x28, 0x05, 0x52, 0x0a, 0x41, 0x63,
	0x74, 0x69, 0x6f, 0x6e, 0x54, 0x79, 0x70, 0x65, 0x22, 0x35, 0x0a, 0x09, 0x41, 0x63, 0x74, 0x69,
	0x6f, 0x6e, 0x52, 0x65, 0x73, 0x12, 0x28, 0x0a, 0x06, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x18,
	...
	0x39, 0x0a, 0x07, 0x4c, 0x69, 0x73, 0x74, 0x52, 0x65, 0x71, 0x12, 0x16, 0x0a, 0x06, 0x55, 0x73,
	0x65, 0x72, 0x49, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x03, 0x52, 0x06, 0x55, 0x73, 0x65, 0x72,
	0x49, 0x64, 0x12, 0x16, 0x0a, 0x06, 0x54, 0x68, 0x69, 0x73, 0x49, 0x64, 0x18, 0x02, 0x20, 0x01,
	0x28, 0x03, 0x52, 0x06, 0x54, 0x68, 0x69, 0x73, 0x49, 0x64, 0x22, 0x62, 0x0a, 0x07, 0x4c, 0x69,
	...
	0x64, 0x65, 0x6f, 0x52, 0x09, 0x56, 0x69, 0x64, 0x65, 0x6f, 0x4c, 0x69, 0x73, 0x74, 0x22, 0x45,
	...
	,
...
var file_favorite_proto_goTypes = []interface{}{
	...
	(*GetFavoritesReq)(nil), // 8: favorite.GetFavoritesReq
	(*GetFavoritesRes)(nil), // 9: favorite.GetFavoritesRes
}
var file_favorite_proto_depIdxs = []int32{
	...
	0, // 4: favorite.GetFavoritesRes.Status:type_name -> favorite.Status
	3, // 5: favorite.GetFavoritesRes.Favorites:type_name -> favorite.FavoriteInfo
	4, // 6: favorite.Favorite.Action:input_type -> favorite.ActionReq
	6, // 7: favorite.Favorite.List:input_type -> favorite.ListReq
	8, // 8: favorite.Favorite.GetFavorites:input_type -> favorite.GetFavoritesReq
	5, // 9: favorite.Favorite.Action:output_type -> favorite.ActionRes
	7, // 10: favorite.Favorite.List:output_type -> favorite.ListRes
	9, // 11: favorite.Favorite.GetFavorites:output_type -> favorite.GetFavoritesRes
