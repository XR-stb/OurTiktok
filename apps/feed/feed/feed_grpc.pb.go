...
func (c *feedClient) Feed(ctx context.Context, in *FeedReq, opts ...grpc.CallOption) (*FeedRes, error) {
	out := new(FeedRes)
	err := c.cc.Invoke(ctx, "/feed.Feed/Feed", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedFeedServer) Feed(context.Context, *FeedReq) (*FeedRes, error) {
...
func _Feed_Feed_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/feed.Feed/Feed",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(FeedServer).Feed(ctx, req.(*FeedReq))
	}
